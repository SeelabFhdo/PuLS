...
@Entity
@Table(name = "ChargeBookings")
public class ChargeBookingAggregate {
    ...
    public ChargeBookingAggregate() {}

    public ChargeBookingAggregate(
            Long originalId,
            @NotNull(message = "The BookerID/booker email must not be empty!") String bookerId,
            ...
            @NotNull float pricePerKWh,
            @NotNull int verifyCode,
