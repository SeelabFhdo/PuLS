...
@ApiModel(value = "ParkingSpaceUpdatedEvent",
        description = "Data structure for updating an parking spaces, containing general "
                + "information regarding its location or pricing.")
class UpdateParkingSpaceCommand (
        val name: String,
    ...
    override fun toString(): String {
        return "UpdateParkingSpaceCommand(name='$name', description='$description', " +
