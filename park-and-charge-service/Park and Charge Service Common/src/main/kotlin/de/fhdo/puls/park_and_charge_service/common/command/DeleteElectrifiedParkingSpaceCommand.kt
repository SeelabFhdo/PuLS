...
@ApiModel(value = "ElectrifiedParkingSpaceDeleteEvent",
        description = "Data structure for deleting an electrified parking space, containing general"
                + " information regarding its location or pricing.")
class DeleteElectrifiedParkingSpaceCommand (
        val name: String,
